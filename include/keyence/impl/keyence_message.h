...
public:
  ...
  static const uint32_t request_header_size = 12 + 4;
  static const uint32_t response_header_size = 12 + 12;
  ...
  static void encodeRequestHeader(uint8_t code, uint32_t size, MutableBuffer buffer)
  {
    insert(buffer.data, static_cast<uint32_t>(request_header_size + size), 0);
  ...
  static void decodeResponseHeader(MutableBuffer buffer, ResponseHeader& header)
  {
